# Image Environment Base Alpine 3 23

Alpine 3.23 base image for Kaptain environment definition builds.
Provides kubectl, yq 4, and common debugging tools in a minimal Alpine
